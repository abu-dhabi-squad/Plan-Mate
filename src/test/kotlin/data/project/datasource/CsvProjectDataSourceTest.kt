...
class CsvProjectDataSourceTest {
    ...
    fun `getAllProjects should return list of projects when read file returns list`(){
        //given
        val resState = listOf(
            State(UUID.fromString("1"), "state1"),
            State(UUID.fromString("2"), "state2"),
            State(UUID.fromString("3"), "state3")
        )
    ...
    fun `createProject should be success when there is no error occur`(){
        //given
        val project = Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "name1", listOf(State(UUID.fromString("id1"), "name1")))
    ...
    fun `editProject should throw Exception when parser throw Exception`(){
        //given
        val project = Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "name2", listOf(State(UUID.fromString("id1"), "name1")))
    ...
    fun `editProject should write nothing when read projects returns empty list`(){
        //given
        val editProject = Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "name1", listOf(State(UUID.fromString("id1"), "name1")))
        every { fileHelper.readFile(any()) } returns listOf()
        //when
    ...
    fun `editProject should edit when project in list`(){
        //given
        val project = Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "name1", listOf(State(UUID.fromString("id1"), "name1")))
        val project2 = Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "name1", listOf(State(UUID.fromString("id1"), "name1")))
   ...
   @Test
    fun `deleteProject should delete when id in list`(){
        //given
        val project1=Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "name1", listOf(State(UUID.fromString("id1"), "name1")))
       val project2=Project(UUID.fromString("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1b"), "name1", listOf(State(UUID.fromString("id1"), "name1")))
        every { fileHelper.readFile(any()) } returns listOf("","")
