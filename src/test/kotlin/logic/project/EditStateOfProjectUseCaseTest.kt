...
class EditStateOfProjectUseCaseTest {
    ...
    fun `should throw ProjectNotFoundException when projectRepository getProjectById returns null`() = runTest{
        ...
        //Given
        val newTaskState = TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "newState1")
        val taskStates = listOf(TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1b"), "state1"), TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1d"), "state2"))
        val project = Project(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1c"), "name1", taskStates)
    ...
    fun `should throw Exception when the projectRepository editProject throw Exception`() = runTest{
        //Given
        val newTaskState = TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "newState1")
        val taskStates = listOf(TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "state1"), TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1d"), "state2"))
        val project = Project(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1c"), "name1", taskStates)
        coEvery { projectRepository.getProjectById(any()) } returns project
    ...
    fun `should call projectRepository editProject function when the state id is found`()= runTest {
        //Given
        val newTaskState = TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "newState1")
        val taskStates = listOf(TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "state1"), TaskState(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1a"), "state2"))
        val project = Project(Uuid.parse("d3b07384-d9a0-4e9f-8a1e-6f0c2e5c9b1c"), "name1", taskStates)
        coEvery { projectRepository.getProjectById(any()) } returns project
        //When
        editStateOfProjectUseCase(project.projectId, newTaskState)
